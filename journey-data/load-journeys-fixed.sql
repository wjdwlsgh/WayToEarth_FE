-- ============================================
-- WayToEarth Journey Data INSERT (수정본)
-- ============================================
-- 작성일: 2025-01-07
-- 실제 DB 스키마에 맞춰 수정됨
-- ============================================
...
INSERT INTO landmarks (journey_id, name, latitude, longitude, distance_from_start, order_index, city_name, country_code, image_url, created_at, updated_at) VALUES
(1, '경복궁', 37.5796, 126.9770, 0, 1, '서울', 'KR', 'https://waytoearth-assets.s3.ap-northeast-2.amazonaws.com/landmarks/gyeongbokgung.jpg', NOW(), NOW()),
(1, '청와대', 37.5869, 126.9744, 1.2, 2, '서울', 'KR', 'https://waytoearth-assets.s3.ap-northeast-2.amazonaws.com/landmarks/cheongwadae.jpg', NOW(), NOW()),
(1, '창덕궁', 37.5794, 126.9910, 3.5, 3, '서울', 'KR', 'https://waytoearth-assets.s3.ap-northeast-2.amazonaws.com/landmarks/changdeokgung.jpg', NOW(), NOW()),
(1, '창경궁', 37.5788, 126.9950, 4.8, 4, '서울', 'KR', 'https://waytoearth-assets.s3.ap-northeast-2.amazonaws.com/landmarks/changgyeonggung.jpg', NOW(), NOW()),
(1, '종묘', 37.5742, 126.9944, 6.5, 5, '서울', 'KR', 'https://waytoearth-assets.s3.ap-northeast-2.amazonaws.com/landmarks/jongmyo.jpg', NOW(), NOW()),
(1, '서울역사박물관', 37.5700, 126.9690, 9.2, 6, '서울', 'KR', 'https://waytoearth-assets.s3.ap-northeast-2.amazonaws.com/landmarks/seoul-history-museum.jpg', NOW(), NOW()),
(1, '덕수궁', 37.5658, 126.9751, 10.5, 7, '서울', 'KR', 'https://waytoearth-assets.s3.ap-northeast-2.amazonaws.com/landmarks/deoksugung.jpg', NOW(), NOW()),
(1, '숭례문', 37.5605, 126.9753, 12.5, 8, '서울', 'KR', 'https://waytoearth-assets.s3.ap-northeast-2.amazonaws.com/landmarks/sungnyemun.jpg', NOW(), NOW());
...
INSERT INTO landmarks (journey_id, name, latitude, longitude, distance_from_start, order_index, city_name, country_code, image_url, created_at, updated_at) VALUES
(2, '여의도 한강공원', 37.5280, 126.9240, 0, 1, '서울', 'KR', 'https://waytoearth-assets.s3.ap-northeast-2.amazonaws.com/landmarks/yeouido-park.jpg', NOW(), NOW()),
(2, '선유도공원', 37.5335, 126.9350, 2.0, 2, '서울', 'KR', 'https://waytoearth-assets.s3.ap-northeast-2.amazonaws.com/landmarks/seonyudo-park.jpg', NOW(), NOW()),
(2, '양화대교', 37.5370, 126.9420, 4.0, 3, '서울', 'KR', 'https://waytoearth-assets.s3.ap-northeast-2.amazonaws.com/landmarks/yanghwa-bridge.jpg', NOW(), NOW()),
(2, '당산철교', 37.5410, 126.9500, 6.0, 4, '서울', 'KR', 'https://waytoearth-assets.s3.ap-northeast-2.amazonaws.com/landmarks/dangsan-bridge.jpg', NOW(), NOW()),
(2, '반포대교', 37.5500, 126.9680, 10.0, 5, '서울', 'KR', 'https://waytoearth-assets.s3.ap-northeast-2.amazonaws.com/landmarks/banpo-bridge.jpg', NOW(), NOW());
...
SELECT
    j.id,
    j.title,
    COUNT(DISTINCT jr.id) as route_points,
    COUNT(DISTINCT l.id) as landmarks
FROM journeys j
